...
Se creará un script en bash que permita instalar la web, la base de datos, el servidor Apache sobre linux ubuntu todo lo necesario para desplegar la web en el servidor. esta estrategia de enfoque es una arquitectura LAMP.
